...
printf "                              \e[1;77mBy @RahulHackz With LOve\e[0m\n"
printf "                 \e[1;93m.:. \e[0m\e[1;77mMrVenom V2.0 \e[0m\e[1;93m.:.\e[0m\n" 
printf "\n"
}
...
command -v msfconsole > /dev/null 2>&1 || { echo >&2 "This tool requires Metasploit Framework but it's not installed. Install it first. Aborting..."; exit 1; }
command -v msfvenom > /dev/null 2>&1 || { echo >&2 "This tool requires MSFVenom !--It comes with Metasploit Framework--! but it's not installed. Try Reinstalling the Metasploit Framework. Aborting..."; exit 1; }
command -v php > /dev/null 2>&1 || { echo >&2 "This tool requires ANY PHP Version but it's not installed. Install it first. Aborting..."; exit 1; }
command -v ssh > /dev/null 2>&1 || { echo >&2 "This tool requires ssh but it's not installed. Install it First. Aborting..."; 
exit 1; }
...
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Starting Server Please Wait...\e[0m\n"
...
printf "\e[1;93m[\e[1;77m!\e[0m\e[1;93m] Invalid option Please CORRECT it annd try it agin\e[0m"
fi
}
dependencies
menu
